...
| 📍 기능 라인 SSOT | 108개 기능 매트릭스 + 프로토타입 연동 | `admin/feature-spec.html` |
...
- ✅ 기능 명세서 ↔ 프로토타입 클릭 연동 (data-feature-id 매핑 25개)
- ✅ MD 다운로드 버튼 (offline-spec.html 우측 상단)
- 🔜 백엔드 + 프론트 8명 합류 후 27주 견적 시작

## 변경 이력 — 주요 마일스톤

- **2026-05-07**: 휴강 Phase 3 이월 결정 / Phase 4 추가 (5단계로 확장) / 일정 재산정 (52주 → 27주, 8명 기준) / data-feature-id 매핑 / MD 다운로드 버튼
