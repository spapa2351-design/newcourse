...
| App state — chapters (커리큘럼→항목 2계층) | L344-356 |
...
| 커리큘럼 CRUD (addChapter/removeChapter/updateChapterTitle) | L362-366 |
| 항목 CRUD (addItem/removeItem/updateItem/updateItemCond) | L368-381 |
| 드래그앤드롭 (커리큘럼 간 이동 포함) | L383-412 |
...
| 우측 사이드바 (커리큘럼→항목 2계층 DnD) | L832-984 |
